    ...
    <main>
        ...
        <section class="hero" aria-label="Hero banner">
            <div class="container">
                ...
                <div class="actions">
                    <button class="btn btn-primary" id="shopNow"><em class="fas fa-arrow-right"><em> Shop Now</button>
                    <button class="btn btn-ghost" id="exploreDeals"><em class="fas fa-clock"><em> Explore Deals</button>
                </div>
            </div>
        </section>
        ...
        <section class="section" id="products" aria-labelledby="prod-title">
            <div class="container">
                <div class="section-header">
                    ...
                    <a href="#" class="view-all">View All <em class="fas fa-arrow-right"><em></a>
                </div>
            ...
            <div class="container">
                ...
                <div class="deal-wrap">
                    ...
                    <div class="deal-content">
                        <span class="tag"><em class="fas fa-bolt"><em> Limited Offer</span>
                        ...
                        <button class="btn btn-primary" id="buyDeal"><em class="fas fa-cart-plus"><em> Add to Cart</button>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="newsletter-wrap">
                    ...
                    <form id="newsletterForm" onsubmit="return false;">
                        ...
                        <button class="btn" id="subscribeBtn"><em class="fas fa-paper-plane"><em> Subscribe</button>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="brand-col">
                    ...
                    <div class="socials">
                        <a href="#" aria-label="Facebook"><em class="fab fa-facebook-f"><em></a>
                        <a href="#" aria-label="Twitter"><em class="fab fa-twitter"><em></a>
                        <a href="#" aria-label="Instagram"><em class="fab fa-instagram"><em></a>
                        <a href="#" aria-label="YouTube"><em class="fab fa-youtube"><em></a>
                    </div>
                </div>
                <div class="col">
                    <h5>Company</h5>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                el.innerHTML = `
                    <div class="icon-wrap"><em class="fas ${cat.icon}"><em></div>
                    <h4>${cat.name}</h4>
